...
module.exports = {
    ...
    initVar: (_, response, next) => {
        response.locals.pageTitle = 'Pokedex, attrapez-les tous !!'; response.locals.pageDescription = `Un pokédex, est une sorte de dictionnaire de tous les pokémon . Ces derniers peuvent se battre
